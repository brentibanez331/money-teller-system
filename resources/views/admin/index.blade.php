...
<main>
    ...
    <div class="flex flex-row justify-start">
        <div class="w-64 h-screen border-solid border-r-2">
            <ul>
                <li class="px-10 py-3.5 bg-gray-100 transition ease-in-out duration-150 border-b-2 flex flex-row items-center">
        ...
        <div class="w-full h-screen bg-neutral-100">
            <div class="m-7">
                ...
                <p class="text-8xl font-bold"><span id="time"></span></p>
