...
<main>
    ...
    <div class="flex flex-row justify-start">
        <div class="w-64 border-solid border-r-2 border-[#292929]">
            <ul>
                <li class="px-10 py-3.5 bg-[#292929] transition ease-in-out duration-150 border-b-2 border-[#292929] flex flex-row items-center">
                ...
                <div class="flex w-full">
                    <div>
                        <div class="mb-10">
                            ...
                            <p class="text-5xl font-bold"><span id="time"></span></p>
                            <p class="text-3xl"><span id="date"></span></p>
                        </div>
                        <div class="flex">
                            <div class="flex p-5 rounded-md border mr-7 border-neutral-600 flex-col justify-center bg-[#1C1C22] hover:scale-105 transition ease-in-out duration-300">
                                <h3 class="text-center text-2xl mb-5 font-bold">Tellers Registered</h3>
                                <div class="text-center">
                                    <h3 class="text-7xl font-bold my-5 text-neutral-300">{{$noOfTellers}}</h3>
                                    <h3 class="text-xl">Tellers</h3>
                                </div>
                            </div>
                            <div class="flex p-5 rounded-md border border-neutral-600 flex-col justify-center bg-[#1C1C22] hover:scale-105 transition ease-in-out duration-300">
                                <h3 class="text-center text-2xl mb-5 font-bold ">Admins Registered</h3>
                                <div class="text-center">
                                    <h3 class="text-7xl font-bold my-5 text-neutral-300">{{$noOfAdmins}}</h3>
                                    <h3 class="text-xl">Admins</h3>
                                </div>
                            </div>
                        </div>
                        <div class="flex p-5 mt-5 rounded-md border border-neutral-600 flex-col justify-center bg-[#1C1C22] hover:scale-105 transition ease-in-out duration-300">
                            <h3 class="text-center text-2xl mb-5 font-bold ">Recent Successful Transactions</h3>
                            @foreach($transactions as $transaction)
                            <div class="text-start border-[1px] rounded-md border-neutral-700 p-5 mb-3.5">
                                <p>{{$transaction->datetime_transaction}}</p>
                                <p>{{ $transaction->sender_name }} <span class="text-success font-bold"> sent {{$transaction->amount_local_currency}} {{$transaction->original_currency}} </span> to {{$transaction->recipient_name}}</p>
                            </div>
                            @endforeach
                        </div>
                    </div>
                    <div class="ml-14 w-6/12">
                        <div class="flex p-5 rounded-md border border-neutral-600 flex-col mb-5 justify-center bg-[#1C1C22] hover:scale-105 transition ease-in-out duration-300">
                            <div class="flex items-center mb-5 justify-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-7"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path fill="#ffffff" d="M75 75L41 41C25.9 25.9 0 36.6 0 57.9V168c0 13.3 10.7 24 24 24H134.1c21.4 0 32.1-25.9 17-41l-30.8-30.8C155 85.5 203 64 256 64c106 0 192 86 192 192s-86 192-192 192c-40.8 0-78.6-12.7-109.7-34.4c-14.5-10.1-34.4-6.6-44.6 7.9s-6.6 34.4 7.9 44.6C151.2 495 201.7 512 256 512c141.4 0 256-114.6 256-256S397.4 0 256 0C185.3 0 121.3 28.7 75 75zm181 53c-13.3 0-24 10.7-24 24V256c0 6.4 2.5 12.5 7 17l72 72c9.4 9.4 24.6 9.4 33.9 0s9.4-24.6 0-33.9l-65-65V152c0-13.3-10.7-24-24-24z"/></svg>
                                <h3 class="text-center text-3xl ml-3 font-bold ">Transactions Made</h3>
                            </div>
                            <h3 class="text-7xl text-center font-bold my-5 text-neutral-300">{{$noOfTransactions}}</h3>
                        </div>
                        <div class="flex p-5 rounded-md border border-neutral-600 flex-col justify-center bg-[#1C1C22] hover:scale-105 transition ease-in-out duration-300">
                            <div class="flex items-center mb-5 justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-7"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path fill="#ffffff" d="M80 104a24 24 0 1 0 0-48 24 24 0 1 0 0 48zm80-24c0 32.8-19.7 61-48 73.3v87.8c18.8-10.9 40.7-17.1 64-17.1h96c35.3 0 64-28.7 64-64v-6.7C307.7 141 288 112.8 288 80c0-44.2 35.8-80 80-80s80 35.8 80 80c0 32.8-19.7 61-48 73.3V160c0 70.7-57.3 128-128 128H176c-35.3 0-64 28.7-64 64v6.7c28.3 12.3 48 40.5 48 73.3c0 44.2-35.8 80-80 80s-80-35.8-80-80c0-32.8 19.7-61 48-73.3V352 153.3C19.7 141 0 112.8 0 80C0 35.8 35.8 0 80 0s80 35.8 80 80zm232 0a24 24 0 1 0 -48 0 24 24 0 1 0 48 0zM80 456a24 24 0 1 0 0-48 24 24 0 1 0 0 48z"/></svg>
                            <h3 class="text-center text-3xl ml-3 font-bold ">Top Branches</h3></div>
                            @foreach ($topBranches as $branch)
                                <h3 class="text-2xl text-center mt-5 text-neutral-300">{{$branch->branch->branch_name}}</h3>
                                <p class="text-center">No. Of Users: {{$branch->branch_count}}</p>
                            @endforeach
