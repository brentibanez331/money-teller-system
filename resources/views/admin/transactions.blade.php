                ...
                class="w-[100rem] text-sm font-light dark:border-neutral-500">
                    ...
                    <tbody>
                        @foreach ($trans as $cont)
                            <tr class="border-t border-b border-neutral-300 ease-in-out hover:bg-[#191919]">
                                <td class="whitespace-nowrap pl-4 py-4 dark:border-neutral-500">
                                    @if ($cont->transaction_status == "COMPLETED")
                                        <p class="text-success-400">COMPLETED</p>
                                    @elseif ($cont->transaction_status == "PENDING")
                                        <p class="text-warnning-400">PENDING</p>
                                    @elseif ($cont->transaction_status == "CANCELLED")
                                        <p class="text-danger-400">CANCELLED</p>
                                    @endif
                                    </td>
                                <td class="flex flex-col whitespace-nowrap py-4 dark:border-neutral-500">
                                    <div class="mb-0.5">
